...
const Banner = ({mediaInfo}) => {
  ...
  return (
    <div className='relative text-white overflow-hidden'>
      <img className='absolute inset-0 brightness-[0.2]' src={`https://image.tmdb.org/t/p/original${mediaInfo.backdrop_path}`}/>
      ...
      <div className='flex-1'>
        ...
        <div className='flex-[2] text-[1.2vw]'>
          <p className='font-bold mb-2 text-[2vw]'>{mediaInfo.original_title}</p>
          ...
          <div className='flex mt-4 items-center gap-4'>
            <div className='flex items-center gap-2'><CircularProgessBar percent={Math.round(mediaInfo.vote_average*10)} size={3.5} strokeWidth={0.3}/>Rating</div>
            <button>
