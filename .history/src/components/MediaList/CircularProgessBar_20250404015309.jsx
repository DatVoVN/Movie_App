...
const CircularProgessBar = ({percent = 90}) => {
  return (
    ...
    <svg width="50px" height="50px">
      ...
      <circle r="20px" cx='25px' cy='25px' strokeWidth="5px" stroke='green' strokeDasharray={"125.65"} fill='none' strokeDashoffset={125.65- (percent / 100 * 125.65) } transform="rotate(-90)" style={{transformOrigin: "center"}}/>
