...
const CircularProgessBar = ({percent = 90, size = 50, strokeWidth = 5}) => {
  ...
  return (
    ...
    <svg width="50px" height="50px">
      ...
      <circle r={radius} cx={size/2} cy={size/2} strokeWidth={strokeWidth} stroke='green' strokeDasharray={2*(radius) * 3.14 } fill='none' strokeDashoffset={125.65- (percent / 100 * 125.65) } transform="rotate(-90)" style={{transformOrigin: "center"}} strokeLinecap='round'/>
