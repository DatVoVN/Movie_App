...
const MovieDetail = () => {
  ...
  useEffect(()=>{
    fetch(`https://api.themoviedb.org/3/movie/${id}?language=en-US?append_to_response=release_dates`, {
      method: "GET",
      headers: {
  ...
  return (
    <div className='relative text-white overflow-hidden'>
      ...
      <div className='flex-1'>
        <img  src={`https://media.themoviedb.org/t/p/w600_and_h900_bestv2${movieInfo.poster_path}`} alt="" srcset="" />
      </div>
        <div className='flex-[2] text-[1.2vw]'>
          ...
          <div className='flex mt-4 items-center gap-4'>
            <div className='flex items-center gap-2'><CircularProgessBar percent={90} size={3.5} strokeWidth={0.3}/>Rating</div>
            <button>
