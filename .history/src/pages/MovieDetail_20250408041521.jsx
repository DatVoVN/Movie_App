...
const MovieDetail = () => {
  ...
  useEffect(()=>{
    fetch(`https://api.themoviedb.org/3/movie/${id}?append_to_response=release_dates`, {
      method: "GET",
      headers: {
      ...
      <div className='flex-1'>
        ...
        <div className='flex-[2] text-[1.2vw]'>
          ...
          <div className='flex mt-4 items-center gap-4'>
            <div className='flex items-center gap-2'><CircularProgessBar percent={Math.round(movieInfo.vote_average*100)} size={3.5} strokeWidth={0.3}/>Rating</div>
            <button>
