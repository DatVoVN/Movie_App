...
const MovieDetail = () => {
  ...
  if(isLoading){
    return <div className='flex h-40 items-center'><div className='w-8 h-8 border border-slate-900 border-4 rounded-full border-t-slate-200 animate-spin'></div></div>
  }
  const certification = (
